...
Used to decode xor in zepto ransomware Really simple, just rename the filename and update the byte array with the key.

Built with accumulo-python3, a library to write Python 3 applications that integrate with [Apache Accumulo](https://accumulo.apache.org/).
